...
(function () {
    ...
    function Ab(a) { L && !1 !== D["zoom-in"] && (a = a.deltaY, 0 > .5 * (0 > a ? 1 : a ? -1 : 0) ? cb() : bb()) } function W(a, b) { ("boolean" === typeof a ? a : !R) === !R && (R = R ? clearTimeout(R) : 1, d(Ua, "on", R), b || sb(R)) } function sb(a) { ua && (ba(O, function () { g(O, "transition-duration", ""); g(O, "transform", "") }), a && (g(O, "transition-duration", Fa + "s"), g(O, "transform", "translateX(0)"))); a && (R = setTimeout(gb, 1E3 * Fa)) } function X() { za && (Wa = Date.now() + 2950, S || (d(p, "menu_", !0), Cb(3E3))) }
    function Cb(a) { S = setTimeout(function () { var b = Date.now(); b >= Wa ? (d(p, "menu_"), S = 0) : Cb(Wa - b) }, a) } function Db(a) { "boolean" === typeof a && (S = a ? S : 0); S ? (S = clearTimeout(S), d(p, "menu_")) : X() } function ib(a) { ca(a, !0); qa = !0; ra = !1; var b = a.touches; b && (b = b[0]) && (a = b); sa = oa * v <= u; la = a.pageX; ma = a.pageY; m(L) } function kb(a) { ca(a); if (qa) { if (ra) { if (sa && ra) { var b = (a = r < -(u / 7) && (z < B || G)) || r > u / 7 && (1 < z || G); if (a || b) yb(z - 1, !0, r / u * 100), a && gb() || b && fb(); r = 0; Z() } m(L, !0) } else Db(); qa = !1 } }
    ...
    function nb(a) { t = r = 0; v = 1; if (N) if (N.onerror) vb(N); else { var b = N; setTimeout(function () { b && N !== b && (vb(b), b = null) }, 650); pb(); Z() } Gb(a); yb(z - 1); d(Va, "error"); rb(z); m(L); Z(); a = P.title; var c = Y("description"), e = Y("button"), f = a || c || e; f && (a && (Na.firstChild.nodeValue = a), c && (Oa.firstChild.nodeValue = c), e && (Pa.firstChild.nodeValue = e), l(Na, a), l(Oa, c), l(Pa, e), g(Ma, "transform", "all" === za ? "" : "none")); za || d(p, "menu_", !0); da(Ma, f); da(Qa, G || 1 < z); da(Ra, G || z < B); Ta.firstChild.nodeValue = 1 < B ? z + " / " + B : ""; wa && wa(z, D) }; window.Spotlight = { init: Za, theme: db, fullscreen: ab, download: eb, autofit: V, next: gb, prev: fb, goto: Fb, close: $a, zoom: Eb, menu_: Db, show: function (a, b, c) { C = a; b && (E = b, va = b.onshow, wa = b.onchange, xa = b.onclose, c = c || b.index); lb(c) }, play: W, addControl: U, removeControl: function (a) { var b = q[a]; b && (La.removeChild(b), q[a] = null) } };
}).call(this);
